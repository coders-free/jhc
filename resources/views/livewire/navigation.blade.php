...
$nav_links = [
    ...
    [
        'name' => 'Escuela LSM',
        'route' => route('escuela.show'),
        'icon' => '<i class="fas fa-chalkboard-teacher"></i>',
        'active' => request()->routeIs('escuela.*'),
    ],
...
<header x-data="{ open: false }" style="background: #00536b; z-index:200" class=" border-b sticky top-0 z-50  shadow-lg">
                ...
                <div class="ml-3 relative">
                            ...
                            <x-slot name="content">
                                ...
                                @can('admin.home')
                                    <a href="{{ route('admin.home') }}" class="block px-4 py-2 text-sm text-gray-700"
                                        role="menuitem" tabindex="-1" id="user-menu-item-0">Administrador</a>
                                @endcan
                                @role('stock')
                                    <a href="{{ route('inventary.index') }}" class="block px-4 py-2 text-sm text-gray-700"
                                        role="menuitem" tabindex="-1" id="user-menu-item-0">Inventario</a>
                                @endrole

                                @can('Leer cursos')
                                    <a href="{{ route('instructor.courses.index') }}"
                                        class="block px-4 py-2 text-sm text-gray-700" role="menuitem" tabindex="-1"
                                        id="user-menu-item-0">Instructor</a>
                                @endcan



                                <a href="{{ route('courses.my-courses') }}" class="block px-4 py-2 text-sm text-gray-700"
                                    role="menuitem" tabindex="-1" id="user-menu-item-0">Mis cursos</a>
                    ...
                    @else
                        ...
                        <a href="{{ route('register') }}"
                            class="ml-4 text-sm text-white dark:text-gray-500 underline">Registro</a>
                    @endauth
        ...
        @auth
            ...
            <div class="pt-4 pb-1 border-t border-gray-200">
                ...
                <div class="mt-3 space-y-1">
                    ...
                    @can('admin.home')
                        <a href="{{ route('admin.home') }}" class="block px-4 py-2 text-sm text-white" role="menuitem"
                            tabindex="-1" id="user-menu-item-0">Administrador</a>
                    @endcan
                    @role('stock')
                        <a href="{{ route('inventary.index') }}" class="block px-4 py-2 text-sm text-whit" role="menuitem"
                            tabindex="-1" id="user-menu-item-0">Inventario</a>
                    @endrole

                    @can('Leer cursos')
                        <a href="{{ route('instructor.courses.index') }}" class="block px-4 py-2 text-sm text-whit"
                            role="menuitem" tabindex="-1" id="user-menu-item-0">Instructor</a>
                    @endcan



                    <a href="{{ route('orders.index') }}" class="block px-4 py-2 text-sm text-whit" role="menuitem"
                        tabindex="-1" id="user-menu-item-0">Mis ordenes</a>
