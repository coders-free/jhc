...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <div class="mx-auto max-w-screen-xl  text-white">
        <div class="md:flex md:justify-between  ">
            ...
            <div class="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
                ...
                <div>
                    ...
                    <ul >
                        <li class="mb-4">
                            <a href="#" class="hover:underline ">Canciones</a>
                        </li>
                        <li>
                            <a href="#" class="hover:underline">Peliculas</a>
                        </li>
                    </ul>
                </div>
                <div>
                    ...
                    <ul >
                        <li class="mb-4">
                            <a href="#" class="hover:underline">Conciertos</a>
                        </li>
                        <li>
                            <a href="#" class="hover:underline">Viajes</a>
                        </li>
                    </ul>
                </div>
            </div>
        ...
        <div class="sm:flex sm:items-center sm:justify-between">
            <span class="text-sm  sm:text-center dark:text-gray-400">© 2022 <a href="https://intelisoftw.com/" class="hover:underline">Juan Hernandez Cruz</a>. Desarrollado por Intelisoftw.
            </span>
