...
Route::get('acerca', [HomeController::class, 'acerca'])->name('acerca');

Route::get('cancioneslsm', [HomeController::class, 'canciones'])->name('canciones');
Route::get('conciertos', [HomeController::class, 'conciertos'])->name('conciertos');
Route::get('diccionariolsm', [HomeController::class, 'diccionario'])->name('diccionario');
Route::get('peliculaslsm', [HomeController::class, 'peliculas'])->name('peliculas');
Route::get('viajes', [HomeController::class, 'viajes'])->name('viajes');

Route::get('LSM', [HomeController::class, 'lsm'])->name('lsm');
...
Route::get('EscuelaLSM',[ContactoController::class, 'show'])->name('escuela.show');
